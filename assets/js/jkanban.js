...
(function () {
    ...
    this.jKanban = function () {
        ...
        this.init = function () {
            //set initial boards
            boardCount = self.options.boards.length;
            __setBoard();
        ...
        this.addBoards = function (boards) {
            ...
            for (var boardkey in boards) {
                ...
                var colWidth = 12 / boardCount;
                if (colWidth < 2) { colWidth = 2}
                boardNode.classList.add('col-md-' + colWidth);
                var boardWrapper = document.createElement('div');
                boardWrapper.dataset.id = board.id;
                boardWrapper.classList.add('kanban-board');
                boardWrapper.classList.add('z-depth-2');
                ...
                boardNode.style.paddingLeft = self.options.gutter;
                boardNode.style.paddingRight = self.options.gutter;
                // header board
                ...
                //board assembly
                boardWrapper.appendChild(headerBoard);
                boardWrapper.appendChild(contentBoard);
                boardWrapper.appendChild(footerBoard);
                boardNode.appendChild(boardWrapper);
                //board add
        ...
        function __setBoard() {
            ...
            boardContainer.classList.add('row');
